...
from Home.views import Plus,Minus,Add_item, Customer_Orders, Home, Menu, Cart, My_Orders, Order_Completed, Order_Food, Order_Shipped, Remove_Item, Success, Summary
